...
using TornBot.Infrastructure.FFScouter;
using TornBot.Infrastructure.TornStats;
...
public class BattleStatService(FfScouterClient ffClient, TornStatClient tsClient)
{
    public async Task<BattleStat?> GetUserBattlestatsById(int playerId)
    {
        ...
        {
            return new BattleStat(tsPlayerStats.Spy.Strength, tsPlayerStats.Spy.Defense, tsPlayerStats.Spy.Speed,
                tsPlayerStats.Spy.Dexterity);
        }
