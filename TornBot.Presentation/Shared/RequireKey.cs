...
public class RequireKey(AccessLevel accessLevel, bool needsFactionAccess)
    : PreconditionAttribute<ApplicationCommandContext>
{
        ...
        IServiceProvider? serviceProvider)
    {
        ...
        var hasRequiredKey = needsFactionAccess
            ? await queryable.AnyAsync(k => k.AccessLevel == accessLevel && k.HasFactionAccess == needsFactionAccess)
            : await queryable.AnyAsync(k => k.AccessLevel == accessLevel);
        ...
        return hasRequiredKey
            ...
            : PreconditionResult.Fail($"Register a key with access level {accessLevel}");
    }
}